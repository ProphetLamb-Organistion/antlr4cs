...
namespace Antlr4.Runtime
{
    ...
    public interface IParserErrorListener : IAntlrErrorListener<IToken>
    {
        ...
        ///     identified
        /// </param>
        void ReportAmbiguity([NotNull] Parser recognizer, [NotNull] DFA dfa, int startIndex, int stopIndex, bool exact, [AllowNull] BitSet ambigAlts,
        ...
        ///     detected
        /// </param>
        void ReportAttemptingFullContext([NotNull] Parser recognizer, [NotNull] DFA dfa, int startIndex, int stopIndex, [AllowNull] BitSet conflictingAlts,
