...
namespace Antlr4.Runtime.Utility
{
    ...
    public interface IIntSet
    {
        ...
        /// </exception>
        [return: NotNull]
        IIntSet AddAll([AllowNull] IIntSet set);
        ...
        /// </returns>
        [return: MaybeNull]
        IIntSet And([AllowNull] IIntSet a);
        ...
        /// </returns>
        [return: MaybeNull]
        IIntSet Complement([AllowNull] IIntSet elements);
        ...
        /// </returns>
        [return: MaybeNull]
        IIntSet Or([AllowNull] IIntSet a);
        ...
        /// </returns>
        [return: MaybeNull]
        IIntSet Subtract([AllowNull] IIntSet a);
