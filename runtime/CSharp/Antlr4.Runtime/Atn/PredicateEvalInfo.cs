...
namespace Antlr4.Runtime.Atn
{
    ...
    public class PredicateEvalInfo : DecisionEventInfo
    {
        ...
        public PredicateEvalInfo([NotNull] SimulatorState state, int decision, [NotNull] ITokenStream input, int startIndex, int stopIndex, [NotNull] SemanticContext semctx,
            bool evalResult, int predictedAlt)
