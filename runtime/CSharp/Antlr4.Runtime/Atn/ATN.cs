...
namespace Antlr4.Runtime.Atn
{
    public class ATN
    {
        ...
        private readonly ConcurrentDictionary<PredictionContext, PredictionContext> contextCache = new();
        ...
        /// </remarks>
        [NotNull] public readonly IList<DecisionState> decisionToState = new List<DecisionState>();

        /// <summary>The type of the ATN.</summary>
        public readonly ATNType grammarType;

        protected internal readonly ConcurrentDictionary<int, int> LL1Table = new();

        /// <summary>The maximum value for any symbol recognized by a transition in the ATN.</summary>
        public readonly int maxTokenType;

        [NotNull] public readonly IDictionary<string, TokensStartState> modeNameToStartState = new Dictionary<string, TokensStartState>();

        [NotNull] public readonly IList<TokensStartState> modeToStartState = new List<TokensStartState>();

        [NotNull] public readonly IList<ATNState> states = new List<ATNState>();

        [NotNull] public DFA[] decisionToDFA = new DFA[0];
        ...
        [NotNull] public DFA[] modeToDFA = new DFA[0];
        ...
        public DFA[] DecisionToDfa
        {
            get
            {
                Debug.Assert(decisionToDFA != null && decisionToDFA.Length == decisionToState.Count);
        ...
        /// <remarks>
        ///     <para>
        ///         This method is not safe for concurrent use. Since recognizers by default share an <see cref="ATN" />
        ...
        {
            Requires.NotNull("ctx", ExceptionArgument.ctx);
            LL1Analyzer anal = new(this);
        ...
        public virtual void AddState([AllowNull] ATNState state)
        {
            if (state != null)
            {
                state.atn = this;
        ...
        /// </exception>
        [return: NotNull]
        public virtual IntervalSet GetExpectedTokens(int stateNumber, [AllowNull] RuleContext context)
        {
