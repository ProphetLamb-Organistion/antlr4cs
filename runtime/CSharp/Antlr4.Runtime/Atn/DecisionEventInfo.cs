...
namespace Antlr4.Runtime.Atn
{
    ...
    public class DecisionEventInfo
    {
        ...
        [NotNull] public readonly ITokenStream input;
        ...
        /// </summary>
        [MaybeNull] public readonly SimulatorState state;

        /// <summary>The token index in the input stream at which the current event occurred.</summary>
        public readonly int stopIndex;

        public DecisionEventInfo(int decision, [AllowNull] SimulatorState state, [NotNull] ITokenStream input, int startIndex, int stopIndex, bool fullCtx)
        {
