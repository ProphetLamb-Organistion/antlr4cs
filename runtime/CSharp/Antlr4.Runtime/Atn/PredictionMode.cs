...
namespace Antlr4.Runtime.Atn
{
    ...
    public sealed class PredictionMode
    {
        ...
        ///         powerful
        ///         <see cref="Ll" />
        ///         prediction abilities to complete successfully.
        ///     </p>
        ///     <p>
        ...
        ///     </p>
        /// </remarks>
        public static readonly PredictionMode Sll = new();
        ...
        ///     </p>
        /// </remarks>
        public static readonly PredictionMode Ll = new();
        ...
        ///     </p>
        /// </remarks>
        public static readonly PredictionMode LlExactAmbigDetection = new();
        ...
        {
            AltAndContextMap configToAlts = new();
            foreach (ATNConfig c in configs)
            {
                BitSet alts;
        ...
        private sealed class AltAndContextConfigEqualityComparator : EqualityComparer<ATNConfig>
        {
            ...
            {
                return HashCode.Combine(7, o.State.stateNumber, o.Context);
            }
