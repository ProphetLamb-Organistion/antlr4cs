...
namespace Antlr4.Runtime.Atn
{
    public class ATNSerializer
    {
        ...
        private readonly IList<string> tokenNames;
        ...
        public virtual List<int> Serialize()
        {
                ...
                i_4++)
            {
                ...
                {
                    throw new NotSupportedException("Serialized ATN data element " + data[i_4] + " element " + i_4 + " out of range " + (int) Char.MinValue + ".." +
                                                    (int) Char.MaxValue);
                }

                int value = (data[i_4] + 2) & 0xFFFF;
                data[i_4] = value;
            }
        ...
        public virtual string Decode(char[] data)
        {
            ...
            {
                string reason = $"Could not deserialize ATN with version {version} (expected {ATNDeserializer.SerializedVersion}).";
            ...
            {
                string reason = $"Could not deserialize ATN with UUID {uuid} (expected {ATNDeserializer.SerializedUuid}).";
                throw new InvalidOperationException(reason);
            }
                ...
                i_8++)
            {
                ...
                buf.Append(src).Append("->").Append(trg).Append(" ").Append(Transition.serializationNames[ttype]).Append(" ").Append(arg1).Append(",").Append(arg2).Append(",")
                    .Append(arg3).Append("\n");
                p += 6;
            }
