...
namespace Antlr4.Runtime.Atn
{
    ...
    public class LexerActionExecutor
    {
        ...
        [NotNull] private readonly ILexerAction[] lexerActions;
        ...
        public LexerActionExecutor([NotNull] ILexerAction[] lexerActions)
        {
            ...
            {
                hashCode = HashCode.Combine(hashCode, lexerAction);
            }
        }
        ...
        /// </returns>
        [return: NotNull]
        public static LexerActionExecutor Append([AllowNull] LexerActionExecutor lexerActionExecutor, [NotNull] ILexerAction lexerAction)
        {
