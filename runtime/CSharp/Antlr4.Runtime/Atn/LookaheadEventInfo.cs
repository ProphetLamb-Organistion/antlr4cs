...
namespace Antlr4.Runtime.Atn
{
    ...
    public class LookaheadEventInfo : DecisionEventInfo
    {
        ...
        ///     an SLL prediction
        /// </param>
        public LookaheadEventInfo(int decision, [AllowNull] SimulatorState state, int predictedAlt, [NotNull] ITokenStream input, int startIndex, int stopIndex, bool fullCtx)
            : base(decision, state, input, startIndex, stopIndex, fullCtx)
        {
            this.PredictedAlternative = predictedAlt;
        }
