...
namespace Antlr4.Runtime.Tree.Pattern
{
    ...
    public class ParseTreeMatch
    {
        ...
        ///     <see langword="null" />
        /// </exception>
        public ParseTreeMatch([NotNull] IParseTree tree, [NotNull] ParseTreePattern pattern, [NotNull] MultiMap<string, IParseTree> labels, [AllowNull] IParseTree mismatchedNode)
        {
            if (tree == null)
            {
