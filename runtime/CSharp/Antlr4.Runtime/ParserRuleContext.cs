...
namespace Antlr4.Runtime
{
    ...
    public class ParserRuleContext : RuleContext
    {
        ...
        public ParserRuleContext([AllowNull] ParserRuleContext parent, int invokingStateNumber)
            : base(parent, invokingStateNumber)
        {
        }

        public static ParserRuleContext EmptyContext { get; } = new();

        public override RuleContext Parent => (ParserRuleContext) base.Parent;
        ...
        /// </remarks>
        public virtual IToken Start => start;
        ...
        /// </remarks>
        public virtual IToken Stop => stop;
        ...
        {
            TerminalNodeImpl t = new(matchedToken);
            AddChild(t);
            t.parent = this;
            return t;
        }
