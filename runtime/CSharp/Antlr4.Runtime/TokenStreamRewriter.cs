...
namespace Antlr4.Runtime
{
    ...
    public class TokenStreamRewriter
    {
        ...
        public virtual void Replace(string programName, int from, int to, [AllowNull] object text)
        {
        ...
        public virtual void Replace(string programName, IToken from, IToken to, [AllowNull] object text)
        {
        ...
        public class RewriteOperation
        {
            ...
            public override string ToString()
            {
                ...
                opName = Utility.Runtime.Substring(opName, index + 1, opName.Length);
        ...
        /// </remarks>
        internal class InsertAfterOp : InsertBeforeOp
        {
