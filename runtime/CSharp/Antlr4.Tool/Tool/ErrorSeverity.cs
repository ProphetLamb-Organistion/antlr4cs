...
namespace Antlr4.Tool
{
    ...
    {
        public static readonly ErrorSeverity INFO = new("info");
        public static readonly ErrorSeverity WARNING = new("warning");
        public static readonly ErrorSeverity WARNING_ONE_OFF = new("warning");

        public static readonly ErrorSeverity ERROR = new("error");
        public static readonly ErrorSeverity ERROR_ONE_OFF = new("error");
        public static readonly ErrorSeverity FATAL = new("fatal"); // TODO: add fatal for which phase? sync with ErrorManager
